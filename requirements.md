...
15. Clicking the Checkout button will take the user to the CheckoutSuccessPage.
    1. The CheckoutSuccessPage should display that the order was successful and clear the cart. There should be a link to go back to the store.
    2. On the ContactPage, create the following inputs with the following requirements.
    3. Full name (Minimum number of characters is 3, required)
    4. Subject (Minimum number of characters is 3, required)
    5. Email (Must be a valid email address, required)
    6. Body (Minimum number of characters is 3, required)
    7. Submit button
16. console.log the data from the form once validation requirements are met.
17. Once your project is done, deploy it to Netlify.
